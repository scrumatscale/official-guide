...
The SM organization (SMs, SoSMs, and EAT) work as a whole to complete the components of the Scrum Master Cycle. The components unique to the Scrum Master Cycle are: 
\begin{itemize}
...
\begin{itemize}
	...
	\item verify the resulting improvements.
\end{itemize}
...
The PO organization (the Product Owners, the CPOs, and the Executive MetaScrum) work as a whole to satisfy the components of the Product Owner Cycle. The components unique to the Product Owner Cycle are:
\begin{itemize}
