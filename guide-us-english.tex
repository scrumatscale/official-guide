...
\begin{itemize}
	\item In the MetaScrum event, the EMT makes decisions for the organization by aligning around a single priortized backlog. The EMT uses this event to understand new information and to change priorties and organizational direction.
