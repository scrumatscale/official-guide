...
\begin{itemize}
	\item At the MetaScrum event, decisions affecting the entire organization get made. Changing direction of the organization, having to fire 20% of all employees, killing products and restructuring the organizational backlog can all happen at this event.
...
\section{Remote/Distributed Teams and Scrum@Scale}
 
Scrum@Scale works for co-located, remote, and distributed teams. A remote team occupies a different location than the rest of the enterprise. An example would be a company with a headquarters in Denmark that has several teams in New Delhi. A distributed team is a team that is in many locations. A distributed team may have team members in New Delhi, New York, and New Brunswick. Scrum@Scale can run, lead, and unify all teams. Having remote teams introduces known risks. These risks come from the challenges:
...
enterprise tool availability
 
feelings of isolation
 
bandwidth limitations
 
communication tool limitations
 
digitization of physical artifacts (backlogs and sprint backlogs)
 
\end{itemize}
 
These risks are manageable. Without extra thoughtfulness and special considerations, remote teams will under-perform.
 
The future of work is software-enabled, uses high bandwidth, digital, and distributed.
 
Scrum@Scale endorses no software, platform, or service. There are two guiding principles. First, the “at work” and “remote work” experience should be equal for all team members. Second, teams over tools. Where tools do not meet team needs, switch tools. No tool is more important than the team that wields it.
 
\subsection{Working on a remote team}
 
Working on a remote, distributed Scrum team requires a team operating agreement. This operating agreement should specify at least:
 
\begin{itemize}
 
Event times (accounting for time zones)
 
Team overlap hours (defined as the hours when the entire team is available)
 
Meeting procedures (physical and digital procedures)
 
Cameras always-on/sometimes-on/never-on
 
Microphone always-on/sometimes-on/never-on
 
Cybersecurity matters (machine and data security)
 
Information protection matters (knowledge safeguarding)
 
Version control and collaboration
 
\end{itemize}
 
The team should sign the operating agreement and have it visible in their team space.
 
Swarming, working together on a single item, is a key pattern for Scrum teams.  Swarming is challenging with distributed teams. Teams should consider a time immediately following the Daily Scrum for swarming. This one-hour time-box is for issues that emerge during the Daily Scrum. If more than one issue emerges as a swarming candidate, the Scrum Master should guide the team. Teams may opt to swarm both issues in series (one after the other) or in parallel (at the same time). If teams swarm in parallel, digital breakout rooms are a best practice.
 
Enterprise tools are important to distributed teams. Remote teams should have equal access to enterprise tools at all locations. Remote teammates should have equal access to all digital tools. Digital tools unite a team and define workflows. Having a common digital tool-set will ensure a consistent look and feel to work. It also ensures that teams can transfer tool learning.
 
Scrum@Scale (all implementations) work because it results in increased psychological safety and team trust. Remote working requires extra effort to build and maintain this trust. Teams should seek ways to build trust and look for signs of trust erosion. Trust erosion and low trust teams have:
...
do not share honest feedback in retrospectives
 
fail to provide backup for team members
 
do not support the product owners prioritization
 
\end{itemize}
 
Scrum teams should experiment and look for ways to build trust with remote teammates. Practices and tools in this area are emergent, so, Scrum Masters should watch trends.
 
\subsection{Leading a remote team}
 
Leading remote Scrum@Scale requires empirical process control. To divide resources leaders must be able to compare teams. Leaders must maximize value by investing in the greatest return on investment. Talent is global and distributed teams can deliver attractive value. Remote teams also need informed and active leadership. Scrum@Scale provides the framework to lead teams without modification. Remote teams are an emergent phenomenon that integrates well with Scrum@Scale. Leaders must understand the current state of trust and increase trust. Leaders act to give all teams the information and resources to flourish. A common pitfall is for a team to starve certain remote workers or data or decisions.
 
Leaders must also use the EMS and EAT to communicate with all teams. Live video communication with chat is the richest for remote teams. Emerging technology may offer richer communication in the future.
 
Scrum teams are autonomous because high performance is possible on the edge of chaos. Enterprise leaders must resolve the tension between digital tools and team autonomy. Autonomous teams should be able to select tools that serve them best. Enterprise software licenses are expensive, and offering many tools is costly. Leadership must balance the needs of teams with enterprise resources through the EAT. No tool is worth undue financial strain. In instances where tools do not meet team needs, teams should adjust to commercial tools. Tailoring tools is not cost-effective and creates high cybersecurity risks. The most secure tool is the tool that has the latest software update. AI exploits tools in near real-time. Few enterprises have the resources to conduct DevSecOps on team collaboration tools. Team collaboration tools safeguard intellectual property and key trade advantages. The EAT must manage the autonomy of teams, resources, and cybersecurity risks.
 
Enterprises should periodically review tool usage and remove those tools that teams don’t use. The decision to remove a tool resides with the EAT.
