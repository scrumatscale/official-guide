...
\subsection{The Components of the Scrum@Scale\texttrademark ~Framework}
\write18{wget https://www.scrumatscale.com/wp-content/uploads/SMPO-Cycle.png}
\includegraphics{SMPO-Cycle.png}
...
The \textbf{Team-Level Process} is laid out clearly in the Scrum Guide. It
...
a SoS in the exact same manner that an SoS interfaces with a single Scrum
team which allows for linear scalability.

Sample Diagrams:

\includegraphics{Sos-R2.png}

\textbf{NOTE:} While the Scrum Guide defines the optimal team size as being
...
discussions, and a single person who is responsible for coordinating the
...
\includegraphics{MetaScrum-R2.png}
...
\includegraphics{ExecMetaScrum.png}
...
\includegraphics{VariableSoS-R2.png}
\includegraphics{OrganizationalDiagram.png}
