...
Guide}}}
\subtitle{\color{gray}Der gültige Leitfaden zu to Scrum@Scale:\\ Skalierung,
die funktioniert}
% \author{}
\date{}
...
\section{Ziel des Scrum@Scale Guides}
Scrum, wie ursprünglich im Scrum Guide beschrieben, ist ein
Rahmenwerk, um komplexe Produkte mit Hilfe eines einzelnen Teams
zu entwickeln, auszuliefern und zu erhalten. Seit seiner Einführung
hat sich die Anwendung auf die Erstellung von Produkten, Prozessen,
Services und Systemen erweitert, die der Zusammenarbeit mehrerer Teams
bedürfen. Scrum@Scale wurde entwickelt, um dieses Ökosystem von Teams
effektiv zu koordinieren, so dass es die gesamte Strategie der Organisation
optimiert. Es erreicht dieses Ziel, indem es mit einer skalierungsfreien
Architektur eine "minimal überlebensnotwendige Bürokratie" aufbaut. Diese
weitet die Arbeitsweise eines einzelnen Scrum Teams organisch auf die
Organisation aus.

Dieser Guide enthält die Definitionen der Komponenten, die das Scrum@Scale
Rahmenwerk ausmachen, inklusive der skalierten Rollen, skalierten Events
und Unternehmensartefakte, sowie der Regeln, die sie zusammenhalten.

Dr. Jeff Sutherland entwickelte Scrum@Scale basierend auf den fundamentalen
Prinzipien von Scrum, der Theorie komplexer adaptiver Systeme, der Spieltheorie 
und objektorientierter Methoden. Dieser Guide wurde in Zusammenarbeit mit vielen
erfahrenen Scrum Anwendern entwickelt und basiert auf den Ergebnissen ihrer Arbeit
vor Ort.
Dieser Guide soll den Leser in die Lage versetzen Scrum@Scale selbst zu implementieren.
